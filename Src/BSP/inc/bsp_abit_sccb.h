...
#define BSP_ABIT_SCCB_SCL_OUT_HIGH                      (BSP_ABIT_SCCB_SCL_SDA_GPIOX->BSRRL = BSP_ABIT_SCCB_SCL_PIN)
#define BSP_ABIT_SCCB_SCL_OUT_LOW                       (BSP_ABIT_SCCB_SCL_SDA_GPIOX->BSRRH = BSP_ABIT_SCCB_SCL_PIN)
#define BSP_ABIT_SCCB_SDA_OUT_HIGH                      (BSP_ABIT_SCCB_SCL_SDA_GPIOX->BSRRL = BSP_ABIT_SCCB_SDA_PIN)
