...
{
    if(state)
        GPIO_SetBits(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_BL_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_BL_PIN);
    else
        GPIO_ResetBits(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_BL_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_BL_PIN);
}
...
static void vigorously_smart_car_lcd_fsmc_config()
{
    ...
    RCC_AHB3PeriphClockCmd(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_FSMC_CLOCK, ENABLE);
...
static void vigorously_smart_car_lcd_gpio_config()
{
    ...
    RCC_AHB1PeriphClockCmd(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_CLOCK | VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_CLOCK |\
                           VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_RS_CLOCK | VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_CS_TFT_CLOCK |\
                           VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_BL_CLOCK, ENABLE);
    
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_GPIOX, GPIO_PinSource0, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_GPIOX, GPIO_PinSource1, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_GPIOX, GPIO_PinSource4, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_GPIOX, GPIO_PinSource5, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_GPIOX, GPIO_PinSource8, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_GPIOX, GPIO_PinSource9, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_GPIOX, GPIO_PinSource10, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_GPIOX, GPIO_PinSource14, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_GPIOX, GPIO_PinSource15, GPIO_AF_FSMC);

    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_GPIOX, GPIO_PinSource7, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_GPIOX, GPIO_PinSource8, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_GPIOX, GPIO_PinSource9, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_GPIOX, GPIO_PinSource10, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_GPIOX, GPIO_PinSource11, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_GPIOX, GPIO_PinSource12, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_GPIOX, GPIO_PinSource13, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_GPIOX, GPIO_PinSource14, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_GPIOX, GPIO_PinSource15, GPIO_AF_FSMC);

    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_RS_GPIOX, GPIO_PinSource12, GPIO_AF_FSMC);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_CS_TFT_GPIOX, GPIO_PinSource12, GPIO_AF_FSMC);
    ...
    GPIO_InitStruct.GPIO_Pin = (VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D00_PIN | VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D01_PIN |\
                                ...
                                VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D15_PIN | VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_RD_PIN |\
                                VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_WR_PIN);
    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF;
    GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_NOPULL;
    GPIO_InitStruct.GPIO_OType = GPIO_OType_PP;
    GPIO_InitStruct.GPIO_Speed = GPIO_Speed_100MHz;
    GPIO_Init(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_D_RD_WR_GPIOX, &GPIO_InitStruct);
    ...
    GPIO_InitStruct.GPIO_Pin = VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_RS_PIN;
    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF;
    GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_NOPULL;
    GPIO_InitStruct.GPIO_OType = GPIO_OType_PP;
    GPIO_InitStruct.GPIO_Speed = GPIO_Speed_100MHz;
    GPIO_Init(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_RS_GPIOX, &GPIO_InitStruct);

    GPIO_InitStruct.GPIO_Pin = VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_CS_TFT_PIN;
    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF;
    GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_NOPULL;
    GPIO_InitStruct.GPIO_OType = GPIO_OType_PP;
    GPIO_InitStruct.GPIO_Speed = GPIO_Speed_100MHz;
    GPIO_Init(VIGOROUSLY_SMART_CAR_DISAPLAY_LCD_CS_TFT_GPIOX, &GPIO_InitStruct);
}
...
void vigorously_smart_car_lcd_display_en(uint16_t line, uint8_t *pstr)
{
    ...
    while(*pstr != '\0')
    {
        if((x - VIGOROUSLY_SMART_CAR_DISAPLAY_WINDOW_X_START + vigorously_smart_car_current_font->Width) > vigorously_smart_car_lcd.vigorously_smart_car_display_x_length)
        {
            x = VIGOROUSLY_SMART_CAR_DISAPLAY_WINDOW_X_START;
            line += vigorously_smart_car_current_font->Height;
        }
        if((line - VIGOROUSLY_SMART_CAR_DISAPLAY_WINDOW_Y_START + vigorously_smart_car_current_font->Height) > vigorously_smart_car_lcd.vigorously_smart_car_display_y_length)
        {
            x = VIGOROUSLY_SMART_CAR_DISAPLAY_WINDOW_X_START;
