...
static void vigorously_smart_car_camera_gpio_config()
{
    ...
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_HREF_PCLK_XCLK_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_HREF_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_HREF_PCLK_XCLK_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_PCLK_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_HREF_PCLK_XCLK_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_PCLK_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_VSYNC_D5_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_VSYNC_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_VSYNC_D5_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D5_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D0_D1_D2_D3_D4_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D0_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D0_D1_D2_D3_D4_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D1_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D0_D1_D2_D3_D4_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D2_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D0_D1_D2_D3_D4_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D3_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D0_D1_D2_D3_D4_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D4_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D6_D7_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D6_PIN, GPIO_AF_DCMI);
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D6_D7_GPIOX, VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_D7_PIN, GPIO_AF_DCMI);
    
    GPIO_InitStruct.GPIO_Pin = (VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_HREF_PIN | VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_PCLK_PIN | VIGOROUSLY_SMART_CAR_DISAPLAY_CAMERA_XCLK_PIN);
...
static vigorously_smart_car_camera_display_window(uint16_t x, uint16_t y)
{
