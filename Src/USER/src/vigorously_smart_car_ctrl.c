...
void vigorously_smart_car_ctrl_init(uint16_t period, uint16_t prescaler)
{
    ...
    GPIO_PinAFConfig(VIGOROUSLY_SMART_CAR_MOTOR_LEFT_GPIOX, GPIO_PinSource6 | GPIO_PinSource7 | GPIO_PinSource8 | GPIO_PinSource9, GPIO_AF_TIM3);
    ...
    GPIO_InitStruct.GPIO_Pin = (VIGOROUSLY_SMART_CAR_MOTORA_PIN_1 | VIGOROUSLY_SMART_CAR_MOTORA_PIN_2 |\
                                VIGOROUSLY_SMART_CAR_MOTORB_PIN_1 | VIGOROUSLY_SMART_CAR_MOTORB_PIN_2);
    ...
    GPIO_InitStruct.GPIO_Pin = (VIGOROUSLY_SMART_CAR_MOTORC_PIN_1 | VIGOROUSLY_SMART_CAR_MOTORC_PIN_2 |\
