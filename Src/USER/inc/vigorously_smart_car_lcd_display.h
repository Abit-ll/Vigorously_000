...
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_CMD                ((uint32_t)0x6C000000)
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_DATA               ((uint32_t)0x6C000000 | (1 << (6 + 1)))

#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_BL_CLOCK           RCC_AHB1Periph_GPIOB
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D_RD_WR_CLOCK      RCC_AHB1Periph_GPIOD
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D_CLOCK            RCC_AHB1Periph_GPIOE
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_RS_CLOCK           RCC_AHB1Periph_GPIOF
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_CS_TFT_CLOCK       RCC_AHB1Periph_GPIOG
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_FSMC_CLOCK         RCC_AHB3Periph_FSMC

#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_BL_GPIOX           GPIOB
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D_RD_WR_GPIOX      GPIOD
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D_GPIOX            GPIOE
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_RS_GPIOX           GPIOF
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_CS_TFT_GPIOX       GPIOG

#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D00_PIN            GPIO_Pin_14
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D01_PIN            GPIO_Pin_15
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D02_PIN            GPIO_Pin_0
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D03_PIN            GPIO_Pin_1
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D04_PIN            GPIO_Pin_7
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D05_PIN            GPIO_Pin_8
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D06_PIN            GPIO_Pin_9
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D07_PIN            GPIO_Pin_10
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D08_PIN            GPIO_Pin_11
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D09_PIN            GPIO_Pin_12
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D10_PIN            GPIO_Pin_13
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D11_PIN            GPIO_Pin_14
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D12_PIN            GPIO_Pin_15
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D13_PIN            GPIO_Pin_8
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D14_PIN            GPIO_Pin_9
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_D15_PIN            GPIO_Pin_10

#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_RD_PIN             GPIO_Pin_4
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_WR_PIN             GPIO_Pin_5
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_RS_PIN             GPIO_Pin_12
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_CS_TFT_PIN         GPIO_Pin_12
#define VIGOROUSLY_SMART_CAR_DISPLAY_LCD_BL_PIN             GPIO_Pin_15
...
#define VIGOROUSLY_SMART_CAR_DISPLAY_WINDOW_X_START         0       /* 起始点坐标 */
#define VIGOROUSLY_SMART_CAR_DISPLAY_WINDOW_Y_START         0       /* 起始点坐标 */
