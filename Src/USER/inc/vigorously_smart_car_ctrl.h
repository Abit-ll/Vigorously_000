...
#define VIGOROUSLY_SMART_CAR_MOTOR_GPIO_CLOCK          (RCC_AHB1Periph_GPIOC | RCC_AHB1Periph_GPIOD)
...
/* MOTORB */
#define VIGOROUSLY_SMART_CAR_MOTORB_PIN_1               GPIO_Pin_8
#define VIGOROUSLY_SMART_CAR_MOTORB_PIN_2               GPIO_Pin_9

#define VIGOROUSLY_SMART_CAR_MOTOR_LEFT_GPIOX           GPIOC

#define VIGOROUSLY_SMART_CAR_MOTOR_LEFT_TIMX            TIM3

/* MOTORC */
#define VIGOROUSLY_SMART_CAR_MOTORC_PIN_1               GPIO_Pin_12
#define VIGOROUSLY_SMART_CAR_MOTORC_PIN_2               GPIO_Pin_13
/* MOTORD */
#define VIGOROUSLY_SMART_CAR_MOTORD_PIN_1               GPIO_Pin_14
#define VIGOROUSLY_SMART_CAR_MOTORD_PIN_2               GPIO_Pin_15

#define VIGOROUSLY_SMART_CAR_MOTOR_RIGHT_GPIOX          GPIOD
